            ...
            <div id='result' style='width:21cm;border-radius:10px;box-shadow:inset 0 0 10px #0084b3;padding:10px; margin: 0 auto;'>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align='left' style="font-size: 13px;">
                                <strong>PARTY A: </strong>OLUMUYIWA OLUMIDE ADENOLA<br/> 
                                <strong>PARTY B:</strong>KADUNA STATE GOVERNMENT<br/> 
                                <strong>PHONE NO.: </strong>08037020814<br/>                                                                                              </td> 
                              <td align='right'><strong>TRANSACTION DATE: </strong>10th June, 2020<br/> 
                                <strong>PRINT DATE: </strong>3rd July, 2020<br/> </td>
                            </tr>
                                ...
                                <table class="table table-striped table-bordered" style="margin-top: 10;margin-bottom: 0;width:100%;table-layout:fixed;border: 1px solid #ddd !important;border-spacing: 0;border-collapse: collapse;font-size: 12px;font-family:Century Gothic">
                                  ...
                                  <tbody>
                                    <tr style="border: 1px solid #ddd !important;">
                                      ...
                                      <td align="left" style="padding: 4px;vertical-align: middle;border: 1px solid #ddd !important;font-size: 12px;"><span class="rptamount">STAMP DUTY ( CERTIFICATE OF OCCUPANCY )</span></td>
                                      <td align="right" style="padding: 4px;vertical-align: middle;background:#effbff !important;border: 1px solid #ddd !important;font-size: 12px; "><span class="rptamount">5,000.00</td>
                                    </tr>
                                        <tr>
                                      ...
                                      <td align="right" style="font-size: 13px; color:#000; font-weight: 700;padding: 4px;vertical-align: middle;background:#effbff !important;border: 1px solid #ddd !important;" >5,000.00</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <br/>
                ...
                <form id="freshform" style="display: inline-block;" method="post">
                    <button type="button" class="btn btn-success btn-md align-content-center" >Print</button>
                </form>
                    </td>
                  </tr>
                </tbody>
